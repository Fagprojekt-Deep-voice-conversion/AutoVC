...
### Run python script
python3 ../Run_AutoVC.py --pretrained_model_path Models/AutoVC/AutoVC_seed40_200k.pt --epochs 50 --model_path_name AutoVC_SMK_trial1 --data_path data/SMK_train/trial1/ --loss_path_name SMK_trial1 --save_every 50000
