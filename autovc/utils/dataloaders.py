...
"""
Denne her Børge bruges simpelthen bare til på mest uelegante vis at give en liste med paths til alle de filer som skal køres igennem træningen.... 
Har lavet en ny funktion 'dataload_clean' som kan det meste af hvad vi har behov for lige nu ....

"""


def dataload_clean(path_to_dir):
	''' This should be able do most of it for SMK '''
	train_data = os.list(path_to_dir)
